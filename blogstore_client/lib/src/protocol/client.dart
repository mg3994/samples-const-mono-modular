...
import 'package:blogstore_client/src/protocol/greetings/greeting.dart'
    as _isf3ihee;
...
class EndpointGreeting extends _isc.EndpointRef {
  ...
  _ida.Future<_isf3ihee.Greeting> hello(String name) =>
      caller.callServerEndpoint<_isf3ihee.Greeting>(
        'greeting',
        'hello',
        {'name': name},
      );
