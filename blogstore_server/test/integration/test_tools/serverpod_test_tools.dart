...
import 'package:blogstore_server/src/generated/greetings/greeting.dart'
    as _i4jwxz9o;
import 'package:serverpod/serverpod.dart' as _is;
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _iacs;
import 'package:serverpod_test/serverpod_test.dart' as _ist;
import 'package:blogstore_server/src/generated/protocol.dart';
import 'package:blogstore_server/src/generated/endpoints.dart';
...
class _GreetingEndpoint {
  ...
  _ida.Future<_i4jwxz9o.Greeting> hello(
    _ist.TestSessionBuilder sessionBuilder,
    String name,
  ) async {
    return _ist.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _ida.Future<_i4jwxz9o.Greeting>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
